...
+ Enemy
	...
	+ Has the following randomly set properties, that controls the way it moves:
		...
		| Accelerated | Starts moving in regular interval, then accelerates to a predetermined value, then returns to regular interval and starts again |
		| Decelerated | Starts moving in regular interval, then decelerates to a predetermined value, then returns to regular interval and starts again |
